...
class CoinGecko {
  ...
  get coins() {
    ...
    return {
       ...
       * @returns {ReturnObject}
       */
      fetchCoinContractMarketChart: async (contractAddress, assetPlatform = 'ethereum', params = {}) => {
        //Must have contractAddress, assetPlatform
        if (!Utils.isString(contractAddress) || Utils.isStringEmpty(contractAddress)) Utils._WARN_('Invalid parameter', 'contractAddress must be of type: String and greater than 0 characters.');
        if (!Utils.isString(assetPlatform) || Utils.isStringEmpty(assetPlatform)) Utils._WARN_('Invalid parameter', 'assetPlatform must be of type: String and greater than 0 characters.');
        ...
        const method = 'GET';
        let path = `/${pathPrefix}/${assetPlatform}/contract/${contractAddress}/market_chart`;
       ...
       * @returns {ReturnObject}
       */
      fetchCoinContractMarketChartRange: async (contractAddress, assetPlatform = 'ethereum', params = {}) => {
        //Must have contractAddress, assetPlatform
        if (!Utils.isString(contractAddress) || Utils.isStringEmpty(contractAddress)) Utils._WARN_('Invalid parameter', 'contractAddress must be of type: String and greater than 0 characters.');
        if (!Utils.isString(assetPlatform) || Utils.isStringEmpty(assetPlatform)) Utils._WARN_('Invalid parameter', 'assetPlatform must be of type: String and greater than 0 characters.');
        ...
        const method = 'GET';
        let path = `/${pathPrefix}/${assetPlatform}/contract/${contractAddress}/market_chart/range`;
  ...
  get finance() {
    return {
       ...
       * @returns {ReturnObject}
       */
      fetchPlatforms: async (params = {}) => {
        const method = 'GET';
        let path = `/finance_platforms`;
